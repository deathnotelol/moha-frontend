  ...
  en: [
    {
      ...
      text: "Domestic security, rule of law, drug hazard prevention and control...",
      link: "https://policeforce.gov.mm/",
    },
    {
      id: 2,
      ...
      text: "Rule of law, peaceful villages, regional development...",
      link: "https://gad.gov.mm/",
    },
    {
      id: 3,
      ...
      text: "Investigates incidents and ensures accountability for offenders...",
      link: "https://www.bsi.gov.mm",
    },
    {
      id: 4,
      icon: "/images/pd_logo.png",
      title: "Prisons Department",
      text: "Secure custody, moral reform, training & rehabilitation activities...",
      link: "https://prisonsdepartment.gov.mm/",
    },
    {
      id: 5,
      icon: "/images/fsd_logo.png",
      title: "Fire Services Department",
      text: "Protects people and properties from fire hazards and related risks...",
      link: "https://www.fsd.gov.mm",
    },
  ],
};

export default function Highlights({ lang = "mm" }) {
  const highlights = highlightsData[lang] || highlightsData.mm;

  return (
    <section
      className="relative py-20 bg-cover bg-center"
      style={{ backgroundColor: "#1A3B66" }}
    >
      {/* overlay */}
      <div className="absolute inset-0 bg-black bg-opacity-50"></div>
      ...
      <div className="relative max-w-6xl mx-auto text-center text-white">
        ...
        <h2 className="relative text-3xl md:text-4xl font-extrabold mb-6 text-white tracking-wide">
          <span className="bg-gradient-to-r from-blue-600 via-yellow-500 to-green-500 bg-clip-text text-transparent p-3">
            {lang === "mm" ? "ပြည်ထဲရေးဝန်ကြီးဌာန" : "Ministry of Home Affairs"}
          </span>
          <span className="block w-36 h-1 mt-5 mx-auto bg-gradient-to-r from-blue-400 to-blue-600 rounded-full"></span>
        </h2>
        ...
        <p className="max-w-3xl mx-auto text-lg md:text-xl text-gray-200 italic drop-shadow-md animate-fadeIn mb-6 md:leading-[34px]">
          {lang === "mm"
            ? "နိုင်ငံတော်လုံခြုံရေး၊ တရားဥပဒေစိုးမိုးရေး၊ ရပ်ရွာအေးချမ်းသာယာရေး၊ ပြည်သူ့အကျိုးပြုဆောင်ရွက်ရေး ဟူသော ရည်မှန်းချက်တာဝန်များကို အကောင်အထည်ဖော် ဆောင်ရွက်လျက်ရှိပါသည်။"
            : "The Ministry of Home Affairs carries out the country's security, rule of law, community welfare, and public service duties."}
        </p>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          {highlights.map((item) => (
            ...
            >
              ...
              {/* text */}
              <p className="text-sm text-gray-600 mb-4 line-clamp-3">{item.text}</p>

              {/* button */}
              <span className="inline-flex items-center gap-1 text-blue-600 font-medium group-hover:underline">
                {lang === "mm" ? "အသေးစိတ်" : "Learn More"}
                <ArrowUpRight className="w-4 h-4" />
              </span>
            </motion.a>
          ))}
